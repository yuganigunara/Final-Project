...
<section class="hero">
    ...
    <section class="products">
        <div class="product-card">
            <img src="images/slider/FF3.jpg" alt="Bairaha Chicken Sausages - 500.00 g">
            <h3>Bairaha Chicken Sausages - 500.00 g</h3>
            <p>Rs712.00</p>
        </div>

        <div class="product-card">
            <img src="images/slider/FFD2.jpg" alt="Goldi Chicken Meatballs - 500.00 g">
            <h3>Goldi Chicken Meatballs - 500.00 g </h3>
            <p>Rs935.00</p>
        </div>

        <div class="product-card">
            <img src="images/slider/MTE01.jpg" alt="Crysbro Whole Chicken - 1.00 kg">
            <h3>Crysbro Whole Chicken - 1.00 kg</h3>
            <p>Rs1340.00</p>
        </div>

        <div class="product-card">
            <img src="images/slider/FF33.jpg" alt="Prima Chicken Meat Balls - 500.00 g">
            <h3>Prima Chicken Meat Balls - 500.00 g</h3>
            <p>Rs890.00</p>
        </div>

        <div class="product-card">
            <img src="images/slider/FF32.jpg" alt="Cresent Crispy Chicken Bacon - 150.00 g">
            <h3>Cresent Crispy Chicken Bacon - 150.00 g</h3>
            <p>Rs615.00</p>
        </div>
        <div class="product-card">
            <img src="images/slider/MTE03.jpg" alt="CIC Skin On Chicken Drumsticks - 575.00 g">
            <h3>CIC Skin On Chicken Drumsticks - 575.00 g</h3>
            <p>Rs963.00</p>
        </div>
        <div class="product-card">
            <img src="images/slider/FFD3.jpg" alt="Crescent Chicken Sausages - 250.00 g">
            <h3>Crescent Chicken Sausages - 250.00 g</h3>
            <p>Rs680.00</p>
        </div>
       <div class="product-card">
            <img src="images/slider/FF31.jpg" alt="Prima Chicken Sausages - 500.00 g">
            <h3>Prima Chicken Sausages - 500.00 g</h3>
            <p>Rs1150.00</p>
        </div>

       <div class="product-card">
            <img src="images/slider/FFD5.jpg" alt="Sam`s Chicken Roll Kids Range - 150.00 g">
            <h3>Sam`s Chicken Roll Kids Range - 150.00 g</h3>
            <p>Rs480.00</p>
        </div>

       <div class="product-card">
            <img src="images/slider/FF8.jpg" alt="Elephant House Pork Lingus - 300.00 g">
            <h3>Elephant House Pork Lingus - 300.00 g</h3>
            <p>Rs1240.00</p>
        </div>
