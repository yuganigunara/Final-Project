...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO payments(name, email, card_number, expiry_date, cvv) 
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo "<script>
                window.onload = function() {
                    ...
                    successModal.show();
                    setTimeout(function() {
                        window.location.href = 'paidmeal1.php'; // Redirect after 3 seconds
...
<div class="container mt-5">
    ...
    <form id="paymentForm" method="POST" action="payments.php" class="mt-4 form-container">
